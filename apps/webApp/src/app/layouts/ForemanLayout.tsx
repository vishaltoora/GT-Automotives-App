  ...
  const menuSections = [
    {
      title: 'Overview',
      items: [
        { text: 'Dashboard', icon: <Dashboard />, path: '/foreman/dashboard' },
        {
          text: 'Appointments',
          icon: <CalendarMonth />,
          path: '/foreman/appointments',
        },
        {
          text: 'Booking Requests',
          icon: <RequestPage />,
          path: '/foreman/booking-requests',
        },
      ],
    },
    {
      ...
      items: [
        ...
        { text: 'Customers', icon: <People />, path: '/foreman/customers' },
        {
          text: 'Vehicles',
          icon: <DirectionsCar />,
          path: '/foreman/vehicles',
        },
        {
          text: 'Inspections',
          icon: <AssignmentTurnedIn />,
          path: '/foreman/inspections',
        },
        {
          text: 'Inspection Items & Pricing',
          icon: <LocalOffer />,
          path: '/foreman/inspection-items',
        },
        {
          text: 'Repair Orders',
          icon: <CarRepair />,
          path: '/foreman/repair-orders',
        },
        { text: 'Inventory', icon: <Inventory />, path: '/foreman/inventory' },
        { text: 'Invoices', icon: <Receipt />, path: '/foreman/invoices' },
        {
          text: 'Quotations',
          icon: <Description />,
          path: '/foreman/quotations',
        },
        {
          text: 'Purchase & Expense Invoices',
          icon: <ShoppingCart />,
          path: '/foreman/purchase-invoices',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      icon: <BarChart />,
      items: [
        { text: 'Reports', icon: <Analytics />, path: '/foreman/reports' },
        {
          text: 'Analytics',
          icon: <Analytics />,
          path: '/foreman/analytics',
        },
      ],
    },
    {
        ...
        >
          <Toolbar sx={{ py: 1 }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              <Chip
                icon={<AccountCircle />}
                label={`${user?.firstName || user?.email || 'Foreman'}`}
                variant="outlined"
                sx={{
