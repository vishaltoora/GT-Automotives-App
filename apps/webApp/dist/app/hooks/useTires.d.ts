import { TireResponseDto as ITire, CreateTireDto as ITireCreateInput, UpdateTireDto as ITireUpdateInput, TireSearchDto as ITireSearchParams } from '@gt-automotive/data';
...
export declare function useTires(params?: ITireSearchParams): import("@tanstack/react-query").UseQueryResult<import("@gt-automotive/data").TireSearchResultResponseDto, Error>;
...
export declare function useUploadTireImage(): import("@tanstack/react-query").UseMutationResult<import("@gt-automotive/data").TireImageDto, Error, {
    tireId: string;
    file: File;
}, unknown>;
